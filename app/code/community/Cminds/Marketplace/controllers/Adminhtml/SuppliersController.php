...
require_once 'Cminds/Supplierfrontendproductuploader/controllers/Adminhtml/SuppliersController.php';
class Cminds_Marketplace_Adminhtml_SuppliersController extends Cminds_Supplierfrontendproductuploader_Adminhtml_SuppliersController
{
    ...
    public function profileAction()
    {
        ...
        Mage::register('current_customer', $customer);
        $block = $this->getLayout()->createBlock('marketplace/adminhtml_customer_edit_tab_profile_edit_form','admin.customer.edit.tab.profile.form.edit');
