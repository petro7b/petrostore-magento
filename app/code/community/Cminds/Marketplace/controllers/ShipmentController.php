...
class Cminds_Marketplace_ShipmentController extends Cminds_Marketplace_Controller_Action {
    ...
    public function saveAction() {
        ...
        $defaultStatus = Mage::getStoreConfig('marketplace_configuration/presentation/set_default_order_status');
        ...
        try {
            ...
            if($fullyShipped) {
                ...
                if($state) {
                    if(Mage::getStoreConfig('marketplace_configuration/presentation/change_order_status_if_completed')) {
