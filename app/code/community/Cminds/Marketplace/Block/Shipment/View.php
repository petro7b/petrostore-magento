...
class Cminds_Marketplace_Block_Shipment_View extends Mage_Core_Block_Template {
    ...
    public function getCarrierName($carrierCode) {
        $carriers = array('firstlogistics' => 'firstlogistics', 'dhl' => 'DHL (Deprecated)', 'fedex' => 'Federal Express', 'ups' => 'United Parcel Service', 'usps' => 'United States Postal Service', 'dhlint' => 'DHL');
