...
class Cminds_Marketplace_Block_Adminhtml_Customer_Edit_Tab_Solditems extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addExpressionFieldToSelect('vendor_amount_with_discount', 'SUM((row_total-main_table.discount_amount)-((row_total-main_table.discount_amount)*(vendor_fee/100)))', 'vendor_fee');
    ...
    protected function _prepareColumns()
    {
        ...
        if($isDiscountEff) {
            ...
            $this->addColumn('vendor_amount_with_discount', array(
                'header' => Mage::helper('marketplace')->__('Net Income With Discount'),
                'width' => '100',
