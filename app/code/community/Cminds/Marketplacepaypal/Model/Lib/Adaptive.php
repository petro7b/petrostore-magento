...
class Cminds_Marketplacepaypal_Model_Lib_Adaptive extends Cminds_Marketplacepaypal_Model_Lib_PayPal
{
    ...
    function loadData($DataArray)
    {
        ...
        $this->XMLNamespace = 'http://api.sandbox.paypal.com/types/ap';
        ...
        if ($this->Sandbox) {
            ...
            $this->EndPointURL = isset($DataArray['EndPointURL']) && $DataArray['EndPointURL'] != '' ? $DataArray['EndPointURL'] : 'https://api.sandbox.paypal.com/';
        } else {
            $this->ApplicationID = isset($DataArray['ApplicationID']) ? $DataArray['ApplicationID'] : '';
            $this->APIUsername = isset($DataArray['APIUsername']) && $DataArray['APIUsername'] != '' ? $DataArray['APIUsername'] : '';
            $this->APIPassword = isset($DataArray['APIPassword']) && $DataArray['APIPassword'] != '' ? $DataArray['APIPassword'] : '';
...
// Generate XML Request
        ...
        if(!$XMLResponse) throw new Exception("Response is empty");
